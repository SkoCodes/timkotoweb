        ...
        <div>
            ...
            <Dialog open={openDialog}>
                <DialogContent style={{textAlign: 'center', fontSize: '15px'}}>
                    ...
                    <Button variant="contained" style={{margin: '20px 0px'}} fullWidth onClick={()=>setOpenDialog(false)} size='small' color='primary'>Continue Editing</Button>
                </DialogContent>
            </Dialog>
            ...
            <Dialog open={openSalaryExceededDialog}>
                <DialogContent style={{textAlign: 'center', fontSize: '15px'}}>
                    ...
                    <Button variant="contained" style={{margin: '20px 0px'}} fullWidth onClick={()=>setOpenSalaryExceededDialog(false)} size='small' color='primary'>Continue Editing</Button>
                </DialogContent>
            </Dialog>
            <Dialog open={openPlayerCountDialog}>
                <DialogContent style={{textAlign: 'center', fontSize: '15px'}}>
                    Lineup Incomplete. Please fill all 9 positions in your lineup. 
                    <Button variant="contained" style={{margin: '20px 0px'}} fullWidth onClick={()=>setOpenPlayerCountDialog(false)} size='small' color='primary'>Continue Editing</Button>
                </DialogContent>
            </Dialog>
